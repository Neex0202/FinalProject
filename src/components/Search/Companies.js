		...
		return(
			...
			<div>
				...
				<a href="#">
					<div className="row">
						<div className="col s3">
							<img className="newsfeed-img z-depth-3" src="assets/img/search-results.jpg"/>
						</div>
						<div className="col s9">
							<br />
							<h5>Global Data Company LLC is hiring Javascript Developers</h5>
							<br />
							<h6>The company just expanded their New York City Office and are hiring.</h6>
						</div>
					</div>
				</a>
				...
				<div className="row center-align">
					<button className="btn waves-effect blue lighten-1 waves-light">More Results</button>
				</div>
			</div>
